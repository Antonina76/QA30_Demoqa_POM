...
public class PracticeFormPage extends BasePages{
    ...
    public PracticeFormPage enterDate(String date) {
        click(dateOfBirtInput);

        String os = System.getProperty("os.name");
    if(os.startsWith("Mac")){
        dateOfBirtInput.sendKeys(Keys.COMMAND,"a");
    }else {
        dateOfBirtInput.sendKeys(Keys.CONTROL,"a");
    }
    dateOfBirtInput.sendKeys(date);
    dateOfBirtInput.sendKeys(Keys.ENTER);
        return this;
